            ...
            <HStack spacing={4}>
              ...
              <Menu>
                ...
                <MenuList zIndex={1001}>
                  {hasRole('employer') && (
                    <MenuItem as={NextLink} href="/dashboard" icon={<Icon as={ChevronRightIcon} />}>
                      HR Dashboard
                    </MenuItem>
                  )}
                  {hasRole('jobseeker') && (
                    <MenuItem as={NextLink} href="/applications" icon={<Icon as={ChevronRightIcon} />}>
                      My Applications
                    </MenuItem>
                  )}
                  <MenuItem as={NextLink} href="/profile" icon={<Icon as={SettingsIcon} />}>
                    Profile Settings
                  </MenuItem>
                  <MenuDivider />
